...
import os,sys,time,random,traceback,json,argparse,readline,subprocess
from core import utils,db,module,Settings,browser
from core.color import *

global modules,all_keywords
modules = db.index_modules()
imgs_path = os.getcwd() + '/core/www/whatsapp'
imgs_to_del = os.listdir(imgs_path)
all_keywords = [
...
def general_commands(command, args=None, full_help=module_help):
	...
	if command=="banner":
		...
		#subprocess.call(['killall', 'firefox-esr', 'geckodriver'])
		exit(0)
